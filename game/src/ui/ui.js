      ...
      <div class="t-left">
        ...
        <div><label>章节（通关解锁 · 预览模式随便选）</label>
          <div class="seg" id="t-ch">
            ...
            <button data-v="4" class="${unlocked < 4 ? 'locked' : ''}">第四章<small>${unlocked < 4 ? '🔒 可预览' : '太空舱 211'}</small></button>
          </div></div>
        <div><label>画质</label>
        ...
        <div class="t-help">鼠标控制视角 · WASD 移动 · E 互动 · F 手电 · V 第一/第三人称 · H 提示 · 失重时空格上浮 / C 下沉 · 预览模式按 N 跳关<br>建议使用电脑浏览器游玩，戴上耳机体验更佳 🎧</div>
      </div>
